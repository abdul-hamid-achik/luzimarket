...
const options: swaggerJsdoc.Options = {
    definition: {
        ...
        tags: [
            ...
            {
                name: 'Reference Data',
                description: 'Reference data endpoints (states, delivery zones, occasions)',
            },
            {
                name: 'Favorites',
            ...
            {
                name: 'Petitions',
                description: 'Customer petitions and requests endpoints',
            },
            {
                name: 'Bundles',
            ...
            {
                name: 'Homepage',
                description: 'Homepage content and carousel management endpoints',
            },
            {
                name: 'Editorial',
                description: 'Editorial articles and content endpoints',
            },
        ],
    },
    apis: [

...
describe('Dinero Page', () => {
    ...
    it('displays period selector with correct default selection', () => {
        ...
        // Month should be selected by default - component uses 'period-btn' and 'active' classes
        expect(monthButton).toHaveClass('period-btn', 'active');
        expect(weekButton).toHaveClass('period-btn');
        expect(weekButton).not.toHaveClass('active');
        expect(yearButton).toHaveClass('period-btn');
        expect(yearButton).not.toHaveClass('active');
    });
    ...
    it('changes period selection when buttons are clicked', () => {
        ...
        expect(weekButton).toHaveClass('period-btn', 'active');
        expect(monthButton).toHaveClass('period-btn');
    ...
    it('has responsive layout classes', () => {
        ...
        // Check for Bootstrap responsive classes - component uses col-lg-3 col-md-6
        const cardsContainer = screen.getByText('Ventas Totales').closest('.col-lg-3');
        expect(cardsContainer).toHaveClass('col-lg-3');
        expect(cardsContainer).toHaveClass('col-md-6');
    });

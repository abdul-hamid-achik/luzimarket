...
function SelectComponent({ onLocationChange = () => { } }) {
  ...
  const handleStateChange = (event) => {
    ...
    setSelectedCity(""); // Reset the selected city when state changes
  ...
  return (
    <div className="row">
      ...
      <div className="col-md-6 mb-3">
        ...
        >
          <option value="">
            {selectedState ? "Seleccionar Ciudad" : "Primero seleccione un estado"}
          </option>

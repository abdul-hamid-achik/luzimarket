      ...
      <footer className="footerContainer">
         <div className="footerContent">
            <div className="footerPrimerPiso">
               <img src={LogoLuziUser} className="bannerLogoFooter" alt="Luzi Market Logo" />
               ...
               <div className="FooterImagenesBannerPiso3">
                  <img src={Facebook} className="bannerRedesSociales2" alt="Facebook" />
                  <img src={Youtube} className="bannerRedesSociales" alt="Youtube" />
                  <img src={Tiktok} className="bannerRedesSociales2" alt="TikTok" />
                  <img src={X} className="bannerRedesSociales2" alt="X (Twitter)" />
                  <img src={Instagram} className="bannerRedesSociales2" alt="Instagram" />
                  <img src={Whatsapp} className="bannerRedesSociales2" alt="WhatsApp" />
               </div>
            </div>

...
const ProductManagement = () => {
    ...
    const { data: deliveryZones = [] } = useDeliveryZones({ active: true });
    ...
    useEffect(() => {
        if (selectedProduct && productDeliveryZones.length > 0) {
    ...
    }, [selectedProduct, productDeliveryZones]);
    ...
    const handleSaveDeliveryZones = async () => {
        ...
        const deliveryZoneUpdates = deliveryZones.map(zone => ({
    ...
    return (
        <div className="product-management">
                ...
                <div className="modal show d-block" tabIndex="-1">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">
                                    Manage Delivery Zones - {selectedProduct?.name}
                                </h5>
                                <button
                                    type="button"
                                    className="btn-close"
            ...
            {showDeliveryZones && <div className="modal-backdrop fade show"></div>}
        </div>
    );
};

...
test.describe('Stripe Webhooks Integration', () => {
    ...
    test.beforeAll(async () => {
        ...
        if (regRes.status === 201) {
            userToken = regRes.data.accessToken || regRes.data.token; // Support both field names
        } else {
            ...
            if (loginRes.status === 200) {
                userToken = loginRes.data.accessToken || loginRes.data.token; // Support both field names
            }
        }
